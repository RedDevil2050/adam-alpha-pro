...
class FactorScoreAgent(IntelligenceAgentBase):
    async def _execute(self, symbol: str, agent_outputs: dict) -> dict:
        try:
            ...
            factor_score = sum(score * weights[factor] 
