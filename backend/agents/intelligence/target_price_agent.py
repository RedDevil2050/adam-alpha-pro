...
async def run(symbol: str) -> dict:
    ...
    if target is None or current is None:
        result = {"symbol": symbol, "verdict": "NO_DATA", "confidence":0.0, "value":None, "details":{}, "score":0.0, "agent_name": agent_name}
    else:
        ...
        if diff > 0.1:
            ...
            verdict="HOLD"
        result = {"symbol": symbol, "verdict": verdict, "confidence":round(score,4), "value":round(diff,4), "details": {"target":target}, "score":score, "agent_name": agent_name}
