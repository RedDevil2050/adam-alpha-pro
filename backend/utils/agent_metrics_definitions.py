...
AGENT_DURATION = Histogram("agent_execution_duration_seconds","Time taken by each agent",["agent"])
AGENT_ERRORS   = Counter("agent_errors_total","Number of errors per agent",["agent"])
CATEGORY_SCORE = Gauge("brain_category_score","Average score by category",["category"])
