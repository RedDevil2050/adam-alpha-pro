...
class QuantStrategies:
    @staticmethod
    def adaptive_momentum(returns: pd.DataFrame, lookback: List[int] = [20, 60, 120]) -> Dict[str, float]:
        signals = {}
    ...
    @staticmethod
    def risk_parity_allocation(returns: pd.DataFrame, risk_target: float = 0.15) -> Dict[str, float]:
