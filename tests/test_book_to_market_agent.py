...
async def test_book_to_market_agent(monkeypatch):
    ...
    monkeypatch.setattr('backend.utils.data_provider.fetch_price_point', lambda s: 100.0) # Mock price point
    ...
    monkeypatch.setattr('backend.utils.data_provider.fetch_historical_price_series', lambda s, start_date, end_date: hist_prices)
